...
# ================== 配置 ==================
CSV_FILENAME = "金圣圭台北线下签售.csv"          # CSV 文件名
GITHUB_REPO = "Juineii/sungkyu_km0311"       # 请替换为您的仓库名
GITHUB_BRANCH = "main"                         # 分支名（main 或 master）
# GitHub Personal Access Token 优先从环境变量 GITHUB_TOKEN 读取，否则需硬编码（不安全，仅测试用）

URL_TAIWAN = "https://www.kmonstar.com.tw/products/%E6%87%89%E5%8B%9F-260515-kim-sung-kyu-6th-mini-album-off-the-map-%E5%B0%88%E8%BC%AF%E7%99%BC%E8%A1%8C%E7%B4%80%E5%BF%B5%E7%B0%BD%E5%90%8D%E6%9C%83-in-taipei.json"
URL_INTERNATIONAL = "https://kmonstar.org/api/v1/event/detail/8c1c5dcb-03f6-4522-a1c6-4c3e515f11fc"
...
def get_stock_international():
    ...
    try:
        ...
        resp.raise_for_status()
        data = resp.json()
        return data['data']['currentOption']['salesQuantity']
    except Exception:
        return None
